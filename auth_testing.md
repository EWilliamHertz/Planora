...
```bash
API_URL="https://unified-schedule-1.preview.emergentagent.com"
...
await page.context.add_cookies([{
    ...
    "domain": "unified-schedule-1.preview.emergentagent.com",
    "path": "/",
    "httpOnly": True,
    "secure": True,
    "sameSite": "None"
}])
await page.goto("https://unified-schedule-1.preview.emergentagent.com")
```
